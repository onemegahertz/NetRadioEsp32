 ...
 * ============================================================
 * Based on CYD-ESP32Marauder and Bruce firmware configurations
 * ============================================================
 */
...
void setupWebServer() {
  ...
  server.on("/api/status", HTTP_GET, []() {
    char j[300];
    snprintf(j, 300, "{\"ssid\":\"%s\",\"ip\":\"%s\",\"volume\":%d,\"current\":%d,\"station\":\"%s\",\"playing\":%s,\"weather\":\"%s\",\"sd\":%s,\"stations\":%d}",
