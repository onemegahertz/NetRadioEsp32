...
**⏰ Время всегда видно!** Текущее время отображается в правом верхнем углу экрана во всех режимах.
...
**Примечание:** 
- Время (HH:MM:SS) всегда видно в правом верхнем углу
- Если название станции длиннее 8 символов, оно будет прокручиваться
- Синхронизация времени через NTP (часовой пояс Москва UTC+3)
